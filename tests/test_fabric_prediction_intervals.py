...
def test_roadmap_records_seasonal_portfolio_integration_and_advances_to_intervals():
    ...
    assert "G21c | Multi-area portfolio-demo integration for independently validated interval evidence | Next" in roadmap
