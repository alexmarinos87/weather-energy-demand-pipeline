...
def parser() -> argparse.ArgumentParser:
    value = argparse.ArgumentParser(
        description="Create one named review of an interval-policy dry run."
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    proposal = read_json(
        args.implementation_dry_run, "implementation_dry_run"
    )
    ...
    review = create_interval_policy_implementation_dry_run_review(
        proposal,
        disposition,
        revision_summary,
        revision_manifest,
