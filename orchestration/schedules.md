...
- a separate reviewed timeout for forecasting after observing target-match and model group sizes;
...
Move to a 15- or 30-minute schedule only after confirming API quotas, source update behaviour, source interval regularity, target coverage, Fabric capacity headroom, forecast-table growth, and downstream latency needs.
